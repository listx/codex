...
*ignored* for purposes of calculationg parity. The =A XOR B= operation resulted
...
computing their parity, and assigning this to a new bit string. That is, the
=0110 1001 1001 0110= in binary get from the Parity column below is =0x6996= in
hexadecimal.
