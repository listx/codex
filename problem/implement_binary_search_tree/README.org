...
Binary search trees are basically [[file:~/prog/codex/problem/implement_binary_tree/README.html][binary trees]] with one major difference:
...
Just like we did for [[file:~/prog/codex/problem/implement_binary_tree/README.html][binary trees]], getting the size is just a field lookup.
...
Deletion is tricky, for the same reasons that we had for [[file:~/prog/codex/problem/implement_binary_tree/README.html][binary trees]].
...
The code here is identical to the code for [[file:~/prog/codex/problem/implement_binary_tree/README.html][binary trees]]. See the discussion
