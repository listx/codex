...
existing [[file:../binary_trees/README.org][binary trees]] implementation's nodes only has links to its children, not
its parent.
...
position in the binary tree. This scheme is the one we used in our [[file:../binary_trees/README.org][binary trees]]
