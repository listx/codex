...
Binary search trees are basically [[file:../binary_trees/README.org][binary trees]] with one major difference:
...
Just like we did for [[file:../binary_trees/README.org][binary trees]], getting the size is just a field lookup.
...
Deletion is tricky, for the same reasons that we had for [[file:../binary_trees/README.org][binary trees]].
...
The code here is identical to the code for [[file:../binary_trees/README.org][binary trees]]. See the discussion
