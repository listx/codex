...
| Name                       | Tags        | References            |
|----------------------------+-------------+-----------------------|
| [[file:problem/linked_lists/README.org][Linked lists]]               | linked list | [cite:@epip 91]       |
| [[file:problem/stacks_with_max/README.org][Stacks (with "max" method)]] | stack       | [cite:@epip 106]      |
| [[file:problem/binary_trees/README.org][Binary trees]]               | tree        | [cite:@epip 123]      |
| [[file:problem/binary_search_trees/README.org][Binary search trees]]        | tree        | [cite:@sedgewick 396] |
