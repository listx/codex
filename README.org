...
| Name                              | Tags        | References            |
|-----------------------------------+-------------+-----------------------|
| [[file:problem/implement_linked_list/README.org][Implement linked list]]             | linked list | [cite:@epip 91]       |
| [[file:problem/implement_stack_with_max/README.org][Implement stack with "max" method]] | stack       | [cite:@epip 106]      |
| [[file:problem/implement_binary_tree/README.org][Implement binary tree]]             | tree        | [cite:@epip 123]      |
| [[file:problem/implement_binary_search_tree/README.org][Implement binary search tree]]      | tree        | [cite:@sedgewick 396] |
