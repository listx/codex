...
The [[file:COPYRIGHT][COPYRIGHT]] file governs everything in this repository, including the
generated HTML files. All source code listings are placed under the [[file:LICENSE][Apache
License, Version 2.0]]. Basically all prose surrounding the code listings is
...
The problems are drawn from [cite:@epip]. Other reference materials are cited
...
There are some [[file:appendix/python_tricks/README.org][Python-language-specific tricks]] available for programming
problems. You might want to skim over this if your Python skills are rusty.

** Mathematics

Some (some would argue /all/) topics in programming have mathematical
underpinnings. See the [[file:appendix/mathematics/README.org][Mathematics]] appendix.
