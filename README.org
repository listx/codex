...
This project aims to capture my notes for studying various programming problems (data structures and algorithms). Have a look at the problems in Section [[* Problems]].

For those curious about how these notes were created, check out Section [[* Literate Programming Build System]].
...
There are some [[file:appendix/python_tricks/README.org][Python-language-specific tricks]] available for programming problems. You might want to skim over this if your Python skills are rusty.

** Mathematics

Some (some would argue /all/) topics in programming have mathematical underpinnings. See the [[file:appendix/mathematics/README.org][Mathematics]] appendix.
