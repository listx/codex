...
"Complement" here comes from the mathematical notion of complements. The "two" here essentially means base 2 (binary). Simply put, if 2 numbers when added together equal a power-of-2 number ($2^N$), they are each others' two's complement.
