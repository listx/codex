...
See https://orgmode.org/manual/CSS-support.html and how we can assign a
particular HTML subclass to a particular headline (heading).

Perhaps even better: https://emacs.stackexchange.com/questions/5980/setting-class-attribute-for-html-table-in-orgmode-export
#+end_comment
